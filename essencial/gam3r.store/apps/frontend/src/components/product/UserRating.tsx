...
export default function UserRating(props: AvaliacoesUsuariosProps) {
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-5 mt-5">
                <div className="flex flex-col gap-2 items-center">
                    <div className="text-7xl text-pink-600">{props.product.assessment}</div>
                    <AssessmentReview assessment={props.product.assessment} size={18} />
